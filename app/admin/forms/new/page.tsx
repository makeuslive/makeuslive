            ...
            <div className="flex-1 flex overflow-hidden">
                ...
                <div className="w-64 shrink-0 bg-white border-r border-gray-200 overflow-y-auto p-4">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="space-y-1">
                            {FIELD_TYPES.filter((t) => FIELD_TYPE_META[t].category === 'basic').map((type) => (
                                <button
                                    key={type}
                    ...
                    {/* Choice Fields */}
                    <div className="mb-4">
                        <p className="text-xs text-gray-500 mb-2">Choice</p>
                        <div className="space-y-1">
                            {FIELD_TYPES.filter((t) => FIELD_TYPE_META[t].category === 'choice').map((type) => (
                                <button
                                    key={type}
                                    onClick={() => addField(type)}
                                    className="w-full flex items-center gap-2 px-3 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-lg transition-colors text-left"
                    ...
                    <div className="mb-4">
                        ...
                        <div className="space-y-1">
                            {FIELD_TYPES.filter((t) => FIELD_TYPE_META[t].category === 'content').map((type) => (
                                <button
                                    key={type}
                                    onClick={() => addField(type)}
                                    className="w-full flex items-center gap-2 px-3 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-lg transition-colors text-left"
                    ...
                    <div>
                        ...
                        <div className="space-y-1">
                            {FIELD_TYPES.filter((t) => FIELD_TYPE_META[t].category === 'advanced').map((type) => (
                                <button
                                    key={type}
                                    onClick={() => addField(type)}
                                    className="w-full flex items-center gap-2 px-3 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-lg transition-colors text-left"
                ...
                <div className="w-80 shrink-0 bg-white border-l border-gray-200 overflow-y-auto">
                    {selectedField ? (
                                ...
                                {!['heading', 'paragraph'].includes(selectedField.type) && (
                                    <div className="flex items-center justify-between py-2">
                                        ...
                                        <button
                                            ...
                                            className={`relative w-11 h-6 rounded-full transition-colors ${selectedField.required ? 'bg-blue-600' : 'bg-gray-200'
                                                }`}
                                        >
                                            <span
                                                className={`absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${selectedField.required ? 'translate-x-5' : ''
                                                    }`}
                                            />
                                        </button>
                                    </div>
                        ...
                        /* Settings Panel when no field selected */
                        <div className="p-4">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 mt-1">Receive email notifications for new submissions</p>
                                </div>
                                ...
                                <div className="flex items-center justify-between py-2 border-t border-gray-100">
                                    ...
                                    <button
                                        ...
                                        className={`relative w-11 h-6 rounded-full transition-colors ${settings.isActive ? 'bg-green-600' : 'bg-gray-200'
                                            }`}
                                    >
                                        <span
                                            className={`absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${settings.isActive ? 'translate-x-5' : ''
                                                }`}
                                        />
                                    </button>
                                </div>
...
// Preview Field Component - renders fields as they would appear to users
