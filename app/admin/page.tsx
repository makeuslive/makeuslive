            ...
            <div className="p-6 lg:p-8 space-y-8">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <Link href="/admin/legal" className="group flex items-center gap-4 p-4 bg-white border border-gray-100 rounded-2xl hover:shadow-lg hover:border-blue-200 transition-all">
                            ...
                            <div>
                                <p className="font-semibold text-gray-900 group-hover:text-purple-600 transition-colors">Legal Pages</p>
                                <p className="text-sm text-gray-500">Privacy & Terms</p>
                            </div>
                        </Link>
                    </div>
                </div>
