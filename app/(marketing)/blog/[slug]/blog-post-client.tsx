...
import { ChevronRight, Calendar, Clock, Twitter, Linkedin, Facebook, Link as LinkIcon, Share2 } from 'lucide-react'
...
export default function BlogPostClient({ post }: { post: PostItem }) {
