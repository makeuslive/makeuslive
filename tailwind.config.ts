...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      animation: {
        'fade-in': 'fadeIn 0.6s cubic-bezier(0.33, 1, 0.68, 1) forwards', // Snappier for high-fps
        'fade-up': 'fadeUp 0.6s cubic-bezier(0.33, 1, 0.68, 1) forwards',
        'scale-in': 'scaleIn 0.8s cubic-bezier(0.33, 1, 0.68, 1) forwards',
        marquee: 'marquee 30s linear infinite',
        'marquee-reverse': 'marquee 30s linear infinite reverse',
        float: 'float 6s ease-in-out infinite',
        'spin-slow': 'spin 10s linear infinite',
        shimmer: 'shimmer 1.8s ease-in-out infinite', // Slightly faster
        shrink: 'shrink linear forwards',
        'pulse-subtle': 'pulseSubtle 2s cubic-bezier(0.4, 0, 0.6, 1) infinite', // New smooth pulse
      },
      keyframes: {
        fadeIn: {
          '0%': { opacity: '0' },
        ...
        fadeUp: {
          '0%': { opacity: '0', transform: 'translateY(30px) translateZ(0)' }, // Reduced distance
          '100%': { opacity: '1', transform: 'translateY(0) translateZ(0)' },
        },
        scaleIn: {
          '0%': { opacity: '0', transform: 'scale(0.9) translateZ(0)' }, // More subtle scale
        ...
        float: {
          ...
          '50%': { transform: 'translateY(-15px) translateZ(0)' }, // Reduced for smoother feel
        },
        shimmer: {
