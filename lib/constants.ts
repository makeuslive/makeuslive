...
export const COPY = {
  ...
  hero: {
    greeting: 'नमस्ते',
    tagline: 'We build internal systems for businesses.',
    cta: 'See Our Work',
  },
  services: {
    badge: 'Our Services',
  ...
  contact: {
    ...
    subheading: "Tell us what you're trying to build or fix. We'll respond with honest feedback.",
    info: {
      email: 'hello@makeuslive.com',
      phone: '+91 98765 43210',
    ...
    form: {
      ...
      message: { label: 'Your Message', placeholder: 'What problem are you trying to solve?' },
      submit: 'Send Message',
      submitting: 'Sending...',
      success: "We got your message. We'll reply within 24 hours.",
